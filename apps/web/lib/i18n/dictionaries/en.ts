...
export const en = {
  ...
  mechanization: {
    kicker: 'Mechanization marketplace',
    title: 'Hire tractors and farm equipment',
    description:
      'Book verified equipment from cooperatives and owners near your plots. Payment is held and only released when the job is confirmed done.',
    browseKicker: 'Browse equipment',
    browseTitle: 'Equipment near you',
    browseEmpty: 'No equipment matches these filters yet.',
    filterType: 'Equipment type',
    filterAllTypes: 'All types',
    filterFrom: 'Available from',
    filterTo: 'Available to',
    listingDetail: 'Listing detail',
    ratesTitle: 'Rates',
    perHa: 'per hectare',
    perHour: 'per hour',
    perKm: 'per km beyond {km} km included',
    serviceArea: 'Service area',
    serviceAreaSummary: '{cells} H3 cells at resolution {res} around base',
    operatorBadge: 'Operator verified',
    operatorPending: 'Operator verification pending',
    operatorSuspended: 'Operator suspended',
    specsTitle: 'Specifications',
    availabilityTitle: 'Availability',
    bookAction: 'Request booking',
    bookingTitle: 'Request a booking',
    plotLat: 'Plot latitude',
    plotLong: 'Plot longitude',
    ...
    quoteTitle: 'Quote',
    quoteBase: 'Base',
    quoteDistance: 'Distance surcharge',
    quoteSeasonal: 'Seasonal multiplier',
    quoteTotal: 'Total',
    confirmAction: 'Accept quote & hold payment',
    cancelAction: 'Cancel booking',
    rateAction: 'Rate the job',
    ownerKicker: 'Owner dashboard',
    ownerTitle: 'Your equipment and bookings',
    ownerEmpty: 'No listings yet — create one to start hiring out equipment.',
    queueTitle: 'Booking queue',
    queueEmpty: 'No bookings in this view.',
    quoteAction: 'Send quote',
    startAction: 'Mark in service',
    completeAction: 'Confirm completion',
    statsTitle: 'Utilization',
    statsBookedHours: 'Booked hours',
    statsRevenue: 'Revenue cleared',
    statsCompletion: 'Completion rate',
    statsListings: 'Listings',
    statusTimeline: 'Status timeline',
    advisoryBadge: 'Flood advisory: {severity}',
    advisoryBasis: 'Basis: {basis}',
    myBookingsTitle: 'My bookings',
    myBookingsEmpty: 'You have not requested any equipment yet.',
    loadError: 'Could not load the mechanization data.',
    holdNote: 'Payment is held in escrow (stub mode) and released on completion.',
    bookingDetail: 'Booking detail'
  },
  // --- end mechanization marketplace (wave-mechanization) ---
  // --- parametric insurance (wave-insurance) ---
  insurance: {
    kicker: 'Parametric insurance',
    title: 'Weather-indexed cover for your plots',
    description:
      'Parametric products pay out automatically when rainfall, flood or heat crosses a trigger — no claims paperwork.',
    catalogKicker: 'Products',
    catalogTitle: 'Parametric product catalog',
    catalogEmpty: 'No parametric products are available on this deployment yet.',
    catalogError: 'Could not load the product catalog.',
    peril: 'Peril',
    triggerLabel: 'Trigger',
    seasonLabel: 'Season',
    payoutBandsLabel: 'Graduated payout',
    premiumRateLabel: 'Base premium rate',
    quoteKicker: 'Quote calculator',
    quoteTitle: 'Price a policy',
    quoteDescription:
      'Preview the premium locally (same rate card as the server), then request the binding quote.',
    quoteProduct: 'Product',
    quotePlot: 'Plot',
    quoteSumInsured: 'Sum insured (₦)',
    quoteFloodBand: 'Flood band (preview)',
    quotePreview: 'Estimated premium',
    quoteSubmit: 'Get binding quote',
    quoteWorking: 'Quoting…',
    quoteResultTitle: 'Server quote',
    quotePremium: 'Premium',
    quoteBasis: 'Pricing data',
    quoteError: 'Quote failed — check the amount and try again.',
    quoteSuccess: 'Policy quoted. Issue it to activate cover.',
    issueAction: 'Issue policy',
    issueWorking: 'Issuing…',
    issueSuccess: 'Policy active — you are covered for the season.',
    issueError: 'Could not issue the policy.',
    policiesKicker: 'My cover',
    policiesTitle: 'My policies',
    policiesEmpty: 'No policies yet — price one above.',
    policiesError: 'Could not load your policies.',
    policySumInsured: 'Sum insured',
    policyPremium: 'Premium',
    statusQuoted: 'Quoted',
    statusActive: 'Active',
    statusTriggered: 'Triggered',
    statusPayoutProposed: 'Payout proposed',
    statusPayoutDisputed: 'Payout disputed',
    statusPayoutRejected: 'Payout rejected',
    statusPayoutAppealed: 'Payout appealed',
    statusPayoutSettled: 'Payout settled',
    statusPaid: 'Paid',
    statusExpired: 'Expired',
    monitorKicker: 'Trigger monitor',
    monitorTitle: 'Recent trigger events',
    monitorEmpty: 'No trigger events yet. Evaluation runs continuously through the season.',
    monitorError: 'Could not load trigger events.',
    evidenceObserved: 'Observed',
    evidenceThreshold: 'Threshold',
    evidenceMargin: 'Breach margin',
    evidenceCell: 'h3 cell',
    basisStub: 'STUB',
    basisLive: 'LIVE',
    basisUnavailable: 'UNAVAILABLE',
    basisWeather: 'Weather data',
    basisFlood: 'Flood data',
    payoutKicker: 'Payouts',
    payoutTitle: 'Payout ledger',
    payoutEmpty: 'No payouts yet.',
    payoutError: 'Could not load payouts.',
    payoutAmount: 'Amount',
    payoutStatus: 'Status',
    payoutExecution: 'Execution',
    payoutExecutionStub: 'STUB — no real disbursement',
    payoutDate: 'Date',
    payoutPolicy: 'Policy',
  ...
  vslaCarbon: {
    kicker: 'VSLA & carbon MRV',
    title: 'Savings groups & carbon estimates',
    description:
      'Village savings & loan groups with ledger-backed cycles and deterministic share-outs, plus carbon MRV for agroforestry plots. Every carbon figure is an ESTIMATE — never verification-grade.',
    groupsKicker: 'Groups',
    groupsTitle: 'VSLA groups, cycles, loans & plots',
    groupsDescription:
      'Register a group, open a savings cycle, record contributions, issue small internal loans and register practice-adoption plots.',
    reportKicker: 'Donor / MRV',
    reportTitle: 'Carbon MRV report',
    reportDescription:
      'Aggregate hectares under practice, survival rates and estimated CO2e — with basis flags on every figure.',
    basisStub: 'STUB — simulated',
    basisEstimate: 'ESTIMATE — not verification-grade',
    basisLive: 'LIVE',
    working: 'Working…',
    groupNameLabel: 'Group name',
    createGroupAction: 'Register group',
    groupsEmpty: 'No VSLA groups yet.',
    chapterLinked: 'chapter-linked',
    selectGroupPrompt: 'Select a group to manage its cycle, loans and plots.',
    cyclesTitle: 'Savings cycle & contributions',
    cyclesEmpty: 'No cycles yet.',
    openCycleLabel: 'Open cycle',
    cycleLabelLabel: 'Cycle label',
    openCycleAction: 'Open cycle',
    closeCycleAction: 'Close cycle & share out',
    shareOutDoneNotice: 'Cycle closed — deterministic share-out posted to the ledger.',
    shareOutTotalLabel: 'Shared out',
    memberLabel: 'Member',
    memberPlaceholder: 'Select a member',
    amountLabel: 'Amount (₦)',
    contributeAction: 'Record contribution',
    contributionRecordedNotice: 'Contribution recorded in the ledger.',
    contributionInvalid: 'Pick a member and enter a positive amount.',
    contributionsEmpty: 'No contributions yet.',
    loansTitle: 'Internal loans',
    borrowerLabel: 'Borrower',
    principalLabel: 'Principal (₦)',
    rateLabel: 'Flat interest rate (%, one-off)',
    issueLoanAction: 'Issue loan',
    loanIssuedNotice: 'Loan issued from the pool.',
    loanRepaidNotice: 'Repayment recorded.',
    loanInvalid: 'Pick a borrower, a positive principal and a rate of 0–30%.',
    loansEmpty: 'No loans yet.',
    repayAction: 'Repay',
    plotsTitle: 'Carbon MRV plots',
    plotNameLabel: 'Plot name',
    practiceLabel: 'Practice',
    hectaresLabel: 'Hectares',
    latLabel: 'Centroid latitude',
    longLabel: 'Centroid longitude',
    registerPlotAction: 'Register plot',
    plotInvalid: 'Enter a name, positive hectares and valid coordinates.',
    plotsEmpty: 'No practice-adoption plots yet.',
    evidenceTitle: 'Seasonal evidence & estimates',
    plotLabel: 'Plot',
    plotPlaceholder: 'Select a plot',
    seasonLabel: 'Season (e.g. 2026-wet)',
    survivalLabel: 'Survival rate (%)',
    ndviLinkLabel: 'Link Sentinel-2 NDVI',
    ndviLinkNo: 'No — attestation only',
    ndviLinkYes: 'Yes — link NDVI assessment',
    submitEvidenceAction: 'Submit evidence',
    evidenceRecordedNotice: 'Evidence recorded.',
    evidenceInvalid: 'Enter a valid season and a survival rate of 0–100.',
    evidenceEmpty: 'No evidence yet.',
    estimateAction: 'Compute estimate',
    estimateRecordedNotice: 'Estimate recorded (labelled estimate — not verification-grade).',
    colMember: 'Member',
    colAmount: 'Amount',
    colDate: 'Date',
    ...
    colRepaid: 'Repaid',
    colStatus: 'Status',
    groupReportTitle: 'Group MRV summary',
    programmeReportTitle: 'Programme MRV summary',
    reportDisclaimer:
      'Estimate only — not verification-grade. No carbon credits are issued, traded or implied; no carbon-standard endorsement is claimed.',
    groupsWord: 'groups',
    evidenceWord: 'Evidence submissions',
    ndviLinkedWord: 'NDVI-linked',
    exportCsvAction: 'Download CSV export',
    practice: {
    ...
    loadError: 'Could not load the VSLA & carbon data.'
  },
  // --- end vsla carbon mrv (wave-vsla-carbon) ---
  // --- livestock passport (wave-livestock-passport) ---
  livestockPassport: {
    kicker: 'Livestock passport',
    title: 'Digital livestock passport',
    description:
      'One verifiable identity document per animal: identity, vet-signed health history, movement legality, liens and ownership — anchored to a tamper-evident hash chain.',
    myPassportsTitle: 'My passports',
    myPassportsDesc: 'Composite passport documents for the animals you currently own.',
    noPassports: 'No passports yet.',
    noPassportsHint: 'Issue a passport for one of your registered animals below.',
    loadError: 'Could not load your livestock passports.',
    issueKicker: 'Issue',
    issueTitle: 'Issue a passport',
    issueDesc:
      'Enter the national animal ID (e.g. NG-BOV-KD-000123) of an animal you own. One passport per animal.',
    animalIdLabel: 'Animal ID',
    issueAction: 'Issue passport',
    issueWorking: 'Issuing…',
    issueSuccess: 'Passport issued — share the verification code with buyers.',
    issueError: 'Could not issue the passport.',
    codeLabel: 'Verification code',
    statusLabel: 'Status',
    speciesLabel: 'Species',
    breedLabel: 'Breed',
    coverageLabel: 'Vaccination coverage',
    movementsLegal: 'All movements permitted',
    movementsIllegal: 'Movement permit gaps',
    chainValid: 'Hash chain verified',
    chainInvalid: 'Hash chain BROKEN',
    tagBasisLabel: 'Tag registry check',
    tagBasisStub: 'STUB — simulated check, no registry contacted',
    eventsAction: 'View event chain',
    eventsTitle: 'Passport event chain',
    hashLabel: 'Event hash',
    verifyChain: 'Re-verify chain',
    transferKicker: 'Ownership transfer',
    transferTitle: 'Initiate a transfer',
    transferDesc:
      'Seller initiates, buyer confirms. Transfers are blocked while an active lien exists on the animal.',
    buyerIdLabel: 'Buyer user ID',
    noteLabel: 'Note (optional)',
    initiateAction: 'Initiate transfer',
    transferInitiated: 'Transfer initiated — the buyer must confirm.',
    transferError: 'Could not initiate the transfer.',
    incomingTitle: 'Incoming transfers (you are the buyer)',
    incomingEmpty: 'No incoming transfers.',
    outgoingTitle: 'Outgoing transfers (you are the seller)',
    outgoingEmpty: 'No outgoing transfers.',
    confirmAction: 'Confirm transfer',
    cancelAction: 'Cancel transfer',
    confirmedNotice: 'Transfer confirmed — ownership moved to you.',
    cancelledNotice: 'Transfer cancelled.',
    transferFailed: 'Transfer action failed.',
    verifyKicker: 'Public verification',
    verifyTitle: 'Verify a passport code',
    verifyDesc:
      'Anyone can verify a passport code (e.g. from a QR tag at the market). The view is redacted: owner identity is initials-only.',
    verifyCodeLabel: 'Passport code',
    verifyAction: 'Verify',
    verifying: 'Verifying…',
    verifyNotFound: 'Code invalid or unknown — forged codes fail verification.',
    verifyResultTitle: 'Verified passport',
    ownerLabel: 'Owner (initials)',
    vaccinationsLabel: 'Vaccinations completed',
    movementLegalityLabel: 'Movement legality',
    encumbranceLabel: 'Encumbrance',
    lienFlag: 'Active lien',
    noLienFlag: 'No active lien',
    insuredFlag: 'Insured',
    notInsuredFlag: 'Not insured',
    legalYes: 'Legal — every movement held a valid permit',
    legalNo: 'Gaps — movements without valid permits',
    withdrawalFlag: 'Treatment withdrawal window active',
    disclaimerStub:
    ...
    qrLabel: 'QR-ready verification path',
    eventsEmpty: 'No events yet.'
  },
  // --- end livestock passport (wave-livestock-passport) ---
  // --- input vouchers (wave-nin-vouchers) ---
  inputVouchers: {
    kicker: 'Input vouchers',
    title: 'Subsidy e-vouchers',
    description:
      'NIN-verified farmer subsidies: allocate, distribute, redeem at agro-dealers, reconcile.',
    stubBadge: 'STUB identity check',
    stubNote: 'Identity checks run in labelled STUB mode — not a live NIMC lookup.',
    programmesKicker: 'Programmes',
    programmesTitle: 'Subsidy programmes',
    programmeNameLabel: 'Programme name',
    sponsorLabel: 'Sponsor',
    capLabel: 'Cap per farmer (₦)',
    budgetLabel: 'Budget (₦)',
    createAction: 'Create programme',
    activateAction: 'Activate',
    closeAction: 'Close',
    createdNotice: 'Programme created as DRAFT — activate it to encumber the budget.',
    activatedNotice: 'Programme activated — budget encumbered in the ledger.',
    programmesEmpty: 'No programmes yet.',
    colStatus: 'Status',
    colBudget: 'Budget',
    colCap: 'Cap per farmer',
    colSponsor: 'Sponsor',
    enrolKicker: 'Enrolment',
    enrolTitle: 'Verify a farmer NIN',
    enrolProgrammeLabel: 'Programme',
    farmerIdLabel: 'Farmer ID',
    ninLabel: 'NIN (11 digits)',
    fullNameLabel: 'Full name',
    stateLabel: 'State',
    cropLabel: 'Main crop',
    enrolAction: 'Verify and enrol',
    enrolledNotice: 'Farmer verified and enrolled.',
    ninMaskLabel: 'NIN on file',
    basisLabel: 'Verification basis',
    allocateKicker: 'Allocation',
    allocateTitle: 'Allocate a voucher',
    amountLabel: 'Amount (₦)',
    allocateAction: 'Allocate voucher',
    allocatedNotice: 'Voucher allocated.',
    distributeAction: 'Distribute',
    distributedNotice: 'Voucher distributed to the farmer.',
    vouchersEmpty: 'No vouchers yet.',
    colVoucher: 'Voucher',
    colAmount: 'Amount',
    colFarmer: 'Farmer',
    farmerKicker: 'My vouchers',
    farmerTitle: 'My subsidy vouchers',
    farmerEmpty: 'You have no vouchers yet.',
    farmerDistributed: 'Ready to redeem',
    farmerPending: 'Not yet distributed',
    expiresLabel: 'Expires',
    redeemKicker: 'Agro-dealer',
    redeemTitle: 'Redeem a voucher',
    redeemCodeLabel: 'Voucher code',
    invoiceLabel: 'Invoice reference',
    redeemAction: 'Redeem',
    redeemedNotice: 'Voucher redeemed against the invoice.',
    reportKicker: 'Reconciliation',
    reportTitle: 'Settlement report',
    reportBudget: 'Budget',
    reportOutstanding: 'Outstanding',
    reportRedeemed: 'Redeemed',
    reportReleased: 'Released (expired + voided)',
    reportLiability: 'Ledger liability',
    reportExpected: 'Expected liability',
    reportTieOk: 'Ledger ties — discrepancy ₦0.',
    reportTieBad: 'Discrepancy found — escalate before settlement.',
    reportByState: 'Totals by state',
    reportBeneficiaries: 'Verified beneficiaries',
    colState: 'State',
    colCount: 'Vouchers',
    working: 'Working…',
    pickProgramme: 'Choose a programme',
    notAdminTitle: 'Restricted area',
    notAdminBody: 'Only programme administrators can manage subsidy programmes.',
    loadError: 'Could not load the input-voucher data.'
  },
  // --- end input vouchers (wave-nin-vouchers) ---
  // --- warehouse receipts (wave-warehouse) ---
  warehouse: {
    kicker: 'Warehouse receipts',
    title: 'Electronic warehouse receipts (e-WHR)',
    description:
      'Deposit your harvest at a certified warehouse, get it graded, and receive a signed electronic warehouse receipt you can pledge for credit, transfer, or redeem for your grain.',
    stubNotice:
      'Demo rail: warehouse certification and the collateral registry are simulated (STUB) until the licensed operator network and national collateral registry are activated.',
    browseKicker: 'Certified warehouses',
    browseTitle: 'Warehouses near you',
    browseEmpty: 'No warehouses match these filters yet.',
    filterState: 'State',
    filterAllStates: 'All states',
    capacityLabel: 'Capacity',
    capacityTonnes: '{tonnes} tonnes',
    certificationLabel: 'Certification',
    certificationChecked: 'Certification re-checked (STUB basis).',
    depositKicker: 'Deposit',
    depositTitle: 'Deposit a crop lot',
    depositWarehouse: 'Warehouse',
    depositCrop: 'Crop',
    depositLot: 'Traceability lot ID (optional)',
    depositAction: 'Deposit lot',
    depositWorking: 'Depositing…',
    depositSuccess: 'Deposit received — the warehouse will grade it next.',
    depositsTitle: 'My deposits',
    depositsEmpty: 'You have not deposited any crop yet.',
    receiptsKicker: 'My receipts',
    receiptsTitle: 'My warehouse receipts',
    receiptsEmpty: 'No receipts yet — deposit a crop lot first.',
    ...
    signatureInvalid: 'Signature INVALID — do not honour this receipt',
    verifyAction: 'Verify signature',
    transferTitle: 'Transfer ownership',
    transferToLabel: 'New owner user ID',
    transferNoteLabel: 'Note (optional)',
    transferAction: 'Transfer receipt',
    transferWorking: 'Transferring…',
    transferSuccess: 'Receipt transferred.',
    redeemAction: 'Redeem (withdraw grain)',
    redeemSuccess: 'Receipt redeemed — the grain was released.',
    pledgeTitle: 'Pledge as collateral',
    pledgePrincipalLabel: 'Loan principal (₦)',
    pledgeTermsLabel: 'Terms (optional)',
    pledgeAction: 'Register pledge',
    pledgeWorking: 'Registering…',
    pledgeSuccess: 'Pledge registered with the collateral registry (STUB).',
    pledgesTitle: 'Pledges',
    pledgesEmpty: 'No pledges on this receipt.',
    principalLabel: 'Principal',
    releaseAction: 'Release pledge',
    releaseSuccess: 'Pledge released.',
    lenderBookKicker: 'Lender desk',
    lenderBookTitle: 'My pledge book',
    lenderBookEmpty: 'No pledges registered yet.',
    transfersTitle: 'Ownership history',
    transfersEmpty: 'No transfers yet.',
    transferFromTo: '{from} → {to}',
    exportKicker: 'Regulator',
    exportTitle: 'Registry audit export',
    exportAction: 'Load export',
    exportEmpty: 'Export not loaded yet.',
    exportCounts: '{receipts} receipts · {pledges} pledges · {transfers} transfers',
    integrationsTitle: 'External integrations',
    certificationDriverLabel: 'Certification feed',
    registryDriverLabel: 'Collateral registry',
    basisStub: 'STUB',
    basisLive: 'LIVE',
    gradingPending: 'Awaiting grading',
    receiptIssued: 'e-WHR issued',
    loadError: 'Could not load the warehouse data.'
  }
